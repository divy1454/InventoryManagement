...
if (isset($_POST['btn_customer_add'])) {
    ...
    if ($row_cphone == $c_phone) {
        ...
        header("Location: http://localhost/newproject/customer.php");
        exit();
    } else {
        $query = "insert into customer(c_name,c_add,c_phone,u_id) values('$c_name','$c_add','$c_phone','$u_id')";
...
if (isset($_POST['btn_customer_edit'])) {
    ...
    $query_edit = "update customer set c_name='$c_name' , c_add='$c_add', c_phone='$c_phone' where id='$c_id'";
