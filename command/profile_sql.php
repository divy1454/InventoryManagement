...
if (isset($_POST['update_btn'])) {
    ...
    if ($ftemp != '') {
        $query_update = "update user set shopname='$shop',username='$uname',mobile_no='$phone',pincode='$pincode',first_name='$fname',last_name='$lname',state='$state',image='$filename' where email='$email'";
        ...
        if ($row > 0) {
            ...
            header("Location: http://localhost/newproject/profile.php");
            exit();
        } else {
            session_start();
        ...
        $query = "update user set shopname='$shop',username='$uname',mobile_no='$phone',pincode='$pincode',first_name='$fname',last_name='$lname',state='$state'where email='$email'";
