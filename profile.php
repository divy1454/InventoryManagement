        ...
        <div class="row box">
            <div class="col-md-3 border-right">
                <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                    ...
                    <br>
                    <span class="btn btn-primary btn-file">Browse<input type="file" accept="image/png, image/jpeg" name="profileimg" required></span>
                ...
                <div class="p-3 py-5">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-12 mt-2">
                            ...
                            <select class="form-select" name="" id="" style="border: 1px solid gray; padding:5px 5px 5px 5px;">
