...
if (isset($_POST['btn_reg'])) {
  ...
  if ($pass == $cpass) {
    ...
    if ($row <= 0) {
      ...
      require 'C:\xampp\htdocs\newproject\PHPMailer\PHPMailer.php';
      require 'C:\xampp\htdocs\newproject\PHPMailer\SMTP.php';
      require 'C:\xampp\htdocs\newproject\PHPMailer\Exception.php';
...
<?php
      ...
      header("Location: http://localhost/newproject/OTP/index.php");
      exit();
    } else {
      session_start();
      ...
      $_SESSION['mail'] = '';
      header("Location: http://localhost/newproject/signup/index.php");
      exit();
    }
  } else {
    session_start();
