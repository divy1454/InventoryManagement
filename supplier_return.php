                                ...
                                <div class="table-responsive">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="table_data_search" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php
                                                $query = "select * from supplier_return where user_id='$u_id'";
                                                $supplier_return_show_result = mysqli_query($con, $query);
                                                while ($row = mysqli_fetch_row($supplier_return_show_result)) {
